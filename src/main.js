...
export default {
  ...
  config: {
    ...
    pages: ['pages/index/main', 'pages/post/main', 'pages/postDetail/main', 'pages/ebook/ebookListPage/main', 'pages/ebook/ebookDesc/main',
      'pages/ebook/ebookDetail/main', '^pages/my/main', 'pages/about/main', 'pages/circle/main', 'pages/login/main', 'pages/purseEbook/main',
      'pages/circleDetail/main', 'pages/publishCircle/main'],
    window: {
